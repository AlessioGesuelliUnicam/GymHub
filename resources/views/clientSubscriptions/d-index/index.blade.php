                ...
                <div class="p-2 relative overflow-x-auto">
                    <table class="w-full text-center  text-sm font-light shadow-md table-auto">
                        ...
                        <tr class="bg-white border-b">
                            <td class="whitespace-nowrap   px-6 py-4 hidden w-1/12">
                                {{$data['clientSubscriptions'][$key]->id}}
                            </td>
                            ...
                            <td>
                                <form method='POST'
                                      action="{{ route('clientSubscriptions.destroy', ['clientSubscription' =>  $data['clientSubscriptions'][$key]->id]) }}">
                                    @csrf
                                    @method('DELETE')
